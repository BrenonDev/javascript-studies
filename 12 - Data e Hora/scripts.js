...
const date6 = Intl.DateTimeFormat().resolvedOptions();
...
// Obtém a diferença de fuso horário em minutos
console.log("Diferença de Fuso Horário em Minutos:", new Date().getTimezoneOffset()); // Exemplo: -180 (para UTC-3)
